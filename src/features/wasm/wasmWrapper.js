...
async function createVerifiableCredential(
  ...
  await isWasmInitialized;
  return wasmExports.createVerifiableCredential(
    issuerDID,
    issuerDIDPrivateKey,
    subjectJSONString
  );
...
async function createInputDescriptor(
  purpose,
  constraintsFieldPath,
  constraintsFieldID
) {
  await isWasmInitialized;
  return wasmExports.createInputDescriptor(
    purpose,
    constraintsFieldPath,
    constraintsFieldID
  );
...
async function createPresentationRequest(
  presentationDefinitionInput,
  signerDID,
  signerPrivateKey,
  holderDID
) {
  await isWasmInitialized;
  return wasmExports.createPresentationRequest(
    presentationDefinitionInput,
    signerDID,
    signerPrivateKey,
    holderDID
...
async function createPresentationSubmission(
  ...
  await isWasmInitialized;
  return wasmExports.createPresentationSubmission(
    presentationDefinitionInput,
    signerDID,
    signerPrivateKey,
    vcJWT
...
async function verifyPresentationSubmission(
  presentationDefinitionInput,
  verifierDID,
  verifierPrivateKey,
  presentationSubmissionJWT
) {
  await isWasmInitialized;
  return wasmExports.verifyPresentationSubmission(
    presentationDefinitionInput,
    verifierDID,
    verifierPrivateKey,
    presentationSubmissionJWT
